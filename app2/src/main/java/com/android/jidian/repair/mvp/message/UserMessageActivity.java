...
import static com.android.jidian.repair.mvp.message.fragment.MessageFragmentEvent.MESSAGE_ALL_READ;
...
import com.android.jidian.repair.mvp.message.fragment.MessageFragmentEvent;
...
public class UserMessageActivity extends BaseActivityByMvp<UserMessagePresenter> implements UserMessageContract.View {
    ...
    public void requestAdvicesAllReadSuccess(BaseBean bean) {
        ...
        EventBus.getDefault().postSticky(new MessageFragmentEvent(MESSAGE_ALL_READ));
    }
