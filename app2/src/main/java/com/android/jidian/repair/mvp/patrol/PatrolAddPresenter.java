 ...
 * description:
 */
public class PatrolAddPresenter extends BasePresenter<PatrolAddContract.View> implements PatrolAddContract.Presenter {

    private PatrolAddContract.Model mModel;

    public PatrolAddPresenter() {
        this.mModel = new PatrolAddModel();
    }
