...
public class ChangePasswordActivity extends BaseActivityByMvp<ChangePasswordPresenter> implements ChangePasswordContract.View {
    ...
    public void initView() {
        ...
        ((TextView) findViewById(R.id.phoneText)).setText(UserInfoHelper.getInstance().getPhone());
        ...
        findViewById(R.id.getcode).setOnClickListener(v -> {
            if (mPresenter != null) {
                mPresenter.requestVerificationCode(UserInfoHelper.getInstance().getPhone());
            }
        });
        ...
        findViewById(R.id.submitText).setOnClickListener(v -> {
            ...
            if (mPresenter != null) {
                mPresenter.requestResetLoginPwd(UserInfoHelper.getInstance().getPhone(), Md5.stringToMD5(newpsdEdit.getText().toString().trim()), codeEdit.getText().toString().trim());
            }
        });
    }
