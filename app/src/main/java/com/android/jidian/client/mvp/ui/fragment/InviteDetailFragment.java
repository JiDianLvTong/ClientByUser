...
import com.android.jidian.client.mvp.ui.adapter.InviteDetailAdapter;
 ...
 * Use the {@link InviteDetailFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class InviteDetailFragment extends BaseFragment<InviteDetailPresenter> implements InviteDetailContract.View {
...
//    }
    ...
    public void initView(View view) {
        ...
        mAdapter = new InviteDetailAdapter(requireContext());
    ...
    private void requestData(boolean refresh) {
        ...
        if (mPresenter != null) {
            ...
            mPresenter.requestPullActivityInviteLists(mAid, "0", mPageNum + "");
        }
    }
