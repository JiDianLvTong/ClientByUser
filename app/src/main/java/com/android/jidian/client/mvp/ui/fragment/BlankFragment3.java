...
public class BlankFragment3 extends BaseFragment {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    //买车列表页访问
                    BuryingPointManager.sendBuryingPoint(BuryingPointManager.ACTIVITY_BUY_CAR_LIST);
                }
            }, 500);
        }
    }
    ...
    private void initData() {
        ...
        Disposable disposable = RetrofitClient.getInstance().getApiService().mapLists(mParam1, mParam2, "0", "3")
