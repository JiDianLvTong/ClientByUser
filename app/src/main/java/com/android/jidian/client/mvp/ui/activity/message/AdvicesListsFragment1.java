...
import static com.android.jidian.client.mvp.ui.activity.message.AdvicesShowActivity.DATABEAN;
import static com.android.jidian.client.mvp.ui.activity.message.AdvicesShowActivity.DATABEANBUNDLE;
...
public class AdvicesListsFragment1 extends BaseFragment<AdvicesLists1Presenter> implements AdvicesLists1Contract.View {
    ...
    public void initView(View view) {
        ...
        fragmentAdvicesLists1SmartRefreshLayout.setRefreshHeader(materialHeader);
        fragmentAdvicesLists1SmartRefreshLayout.setEnableHeaderTranslationContent(true);
        fragmentAdvicesLists1SmartRefreshLayout.setOnRefreshListener(new com.scwang.smart.refresh.layout.listener.OnRefreshListener() {
            @Override
        ...
        fragmentAdvicesLists1SmartRefreshLayout.setOnLoadMoreListener(new com.scwang.smart.refresh.layout.listener.OnLoadMoreListener() {
            @Override
                ...
                if (isFirstIn) {
                    ...
                    adapter.setOnClickListener(new AdvicesListsAdapter.onClickListener() {
                        ...
                        public void onItemViewClick(View itemView) {
                            ...
                            Intent intent = new Intent(requireContext(), AdvicesShowActivity.class);
                            Bundle args = new Bundle();
