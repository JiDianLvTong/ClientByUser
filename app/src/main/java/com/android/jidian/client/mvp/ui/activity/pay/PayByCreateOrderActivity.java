...
public class PayByCreateOrderActivity extends U6BaseActivity {
    ...
    public void onEvent(MainAppEventBean event) {
        if (event != null) {
            if (event.getEvent() == PAYSUCCESSCLOSEORDER) {
                if (Util.isTopActivity("PayByCreateOrderActivity", this)) {
                    finish();
                ...
                if ("0".equals(type)) {
                    ...
                    try {
                        ...
                        if ("1".equals(status)) {
                            ...
                            MyBaseAdapter1 simpleAdapter = new MyBaseAdapter1(datalist_order, new int[]{R.layout.u6_activity_pay_create_order_item, R.layout.u6_activity_pay_create_order_item_v2, R.layout.u6_activity_pay_create_order_item_v3});
