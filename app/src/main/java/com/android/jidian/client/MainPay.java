...
public class MainPay {
    ...
    MainPay(Activity activity, String pay_type, String gid, String uid, String select_pack_month) {
    ...
    //钱包支付
    MainPay(Activity activity, String pay_type, String gid, String uid, int a, int b, String select_pack_month) {
        this.activity = activity;
        this.pay_type = pay_type;
        this.gid = gid;
        this.uid = uid;
    ...
    //钱包月租和包月一起支付
    MainPay(Activity activity, String pay_type, String gid, String uid, int a, int b, int c, int d, int e, int f, int g, String select_pack_month) {
        this.activity = activity;
        this.pay_type = pay_type;
        this.gid = gid;
        this.uid = uid;
    ...
    //生成订单之后支付
    MainPay(Activity activity, String pay_type, String orderno, String uid, String otype, int a, int b, int c, int d, int e, int f, int g, int h) {
        this.activity = activity;
        this.pay_type = pay_type;
