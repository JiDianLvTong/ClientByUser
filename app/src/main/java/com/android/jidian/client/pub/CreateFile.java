...
public class CreateFile {
    ...
    public static String SELFDIR = SD_CARD + "jidian/";
    ...
    private void init() {
        ...
        if (ExistSDCard()) {
            ...
            if (!file.exists()) {
                file.mkdirs();
                System.out.println("在SD上创建jidian文件夹!");
            } else {
                System.out.println("SD上jidian文件夹以创建!");
            }
            ...
            if (!musicfile.exists()) {
                musicfile.mkdirs();
                System.out.println("在jidian文件夹里创建HTML文件夹!");
            } else {
                System.out.println("文件夹HTML在jidian里已创建!");
            }
            ...
            String filePath = "/data/data/jidian/";
            File file = new File(filePath);
            if (file.exists()) {
