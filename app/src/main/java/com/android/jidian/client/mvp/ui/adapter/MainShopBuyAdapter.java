 ...
 * description:
 */
public class MainShopBuyAdapter extends BaseQuickAdapter<ShopBuyBean.DataBean.PacksBean, BaseViewHolder> {

    public MainShopBuyAdapter() {
        super(R.layout.main_shop_item);
    }

    @Override
    protected void convert(BaseViewHolder helper, ShopBuyBean.DataBean.PacksBean bean) {
