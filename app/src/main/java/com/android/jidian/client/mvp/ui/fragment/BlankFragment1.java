...
public class BlankFragment1 extends BaseFragment {
    ...
    public static BlankFragment1 newInstance(String param1, String param2, String param3) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mParam1 = getArguments().getString(ARG_PARAM1);//jingdu
            mParam2 = getArguments().getString(ARG_PARAM2);//weidu
            mParam3 = getArguments().getString(ARG_PARAM3);//type
            Log.d("testlocation123", "onCreate: invalidPosition: " + invalidPosition);
            initData();
        }
    }
    ...
    public void refreshData(String type) {
        ...
        mParam3 = type;
        Log.d("testlocation123", "refreshData: invalidPosition: " + invalidPosition);
        Log.d("testlocation123", "refreshData: longitude: " + longitude);
        Log.d("testlocation123", "refreshData: latitude: " + latitude);
        Log.d("testlocation123", "refreshData: type: " + mParam3);
        ...
        if (isVisibleToUser) {
            if (isFirstVisible) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        //换电列表页访问
                        BuryingPointManager.sendBuryingPoint(BuryingPointManager.ACTIVITY_POWER_CHANGE_LIST);
                    }
                }, 500);
            }
        }
    ...
    private void initData() {
        ...
        Disposable disposable = RetrofitClient.getInstance().getApiService().mapLists(mParam1, mParam2, mParam3, "1")
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.blank1_imageview1:
                //点击地图按钮
                BuryingPointManager.sendBuryingPoint(BuryingPointManager.BUTTON_POWER_CHANGE_LIST_MAP);
    ...
    private class RecyclerView_Adapter extends RecyclerView.Adapter<RecyclerView_Adapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
            ...
            if (volt == 0) {
                holder.imageView48v.setVisibility(View.GONE);
                holder.imageView68v.setVisibility(View.GONE);
            } else if (volt == 48) {
                holder.imageView48v.setVisibility(View.VISIBLE);
                holder.imageView68v.setVisibility(View.GONE);
            } else if (volt == 60) {//是60不是68
                holder.imageView48v.setVisibility(View.GONE);
            ...
            holder.call.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //点击拨打商家带电话按钮
                    BuryingPointManager.sendBuryingPoint(BuryingPointManager.BUTTON_POWER_CHANGE_LIST_CALL_BUSINESS);
                    callPhone(dataBean.getPhone());
                }
            });
            holder.sign.setOnClickListener(v -> {
                //点击导航按钮
                BuryingPointManager.sendBuryingPoint(BuryingPointManager.BUTTON_POWER_CHANGE_LIST_NAVIGATION);
            ...
            holder.itemView.setOnClickListener(v -> {
                //点击站点进入商家
                BuryingPointManager.sendBuryingPoint(BuryingPointManager.BUTTON_POWER_CHANGE_LIST_ITEM);
                uid = sharedPreferences.getString("id", "");
                if (!uid.isEmpty()) {
                    List<ParamTypeData> dataList1 = new ArrayList<>();
