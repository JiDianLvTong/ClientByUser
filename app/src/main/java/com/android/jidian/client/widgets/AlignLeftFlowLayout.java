 ...
 */
public class AlignLeftFlowLayout extends ViewGroup {
    //存储行的集合，管理行
    ...
    public AlignLeftFlowLayout(Context context) {
        this(context, null);
    }

    public AlignLeftFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        //获取自定义属性
    ...
    public class Line {
        ...
        void layout(int left_, int top_) {
            ...
            for (View view : views) {
                ...
                int right = measuredWidth + left_;
                int bottom = measuredHeight + top_;
                //指定位置
                view.layout(left_, top_, right, bottom);
                //更新left
                left_ += measuredWidth + space;
            }
        }
    }
}