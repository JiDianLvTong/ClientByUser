package com.android.jidian.client.service;
...
public class BluetoothChatService {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Main.TOAST, "连接失败");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(Main.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Main.TOAST, "蓝牙已断开连接");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(Main.MESSAGE_READ, bytes, -1, buffer2)
                            .sendToTarget();
                    }
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(Main.MESSAGE_WRITE, buffer.length, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
