 ...
 * description:
 */
public class MainShopRentAdapter extends BaseQuickAdapter<ShopRentBean.DataBean.PacksBean, BaseViewHolder> {

    public MainShopRentAdapter() {
        super(R.layout.main_shop_item);
    }

    @Override
    protected void convert(BaseViewHolder helper, ShopRentBean.DataBean.PacksBean bean) {
...
//        helper.setText(R.id.tv_main_shop_item_detail)
    }
