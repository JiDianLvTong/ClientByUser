...
public class AdvicesListsFragment2 extends BaseFragment<AdvicesLists2Presenter> implements AdvicesLists2Contract.View {
    ...
    public void initView(View view) {
        ...
        fragmentAdvicesLists2SmartRefreshLayout.setRefreshHeader(materialHeader);
        fragmentAdvicesLists2SmartRefreshLayout.setEnableHeaderTranslationContent(true);
        fragmentAdvicesLists2SmartRefreshLayout.setOnRefreshListener(new com.scwang.smart.refresh.layout.listener.OnRefreshListener() {
            @Override
