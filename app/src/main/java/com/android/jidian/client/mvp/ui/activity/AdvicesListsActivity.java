...
import com.android.jidian.client.mvp.ui.fragment.AdvicesListsFragment1;
import com.android.jidian.client.mvp.ui.fragment.AdvicesListsFragment2;
...
public class AdvicesListsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText(getString(R.string.str_title_message));
        tvRightTitle.setText(getString(R.string.str_all_read));
        initView();
    }
